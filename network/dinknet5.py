...
class DinkNet34(nn.Module):
    def __init__(self, num_classes=1, pool_old=1, in_channels=4):
        ...
        self.eca0 = eca_layer(filters[0])
        self.eca1 = eca_layer(filters[0])
        self.eca2 = eca_layer(filters[1])

        self.cc0 = CC_module(filters[0])
        self.cc1 = CC_module(filters[0])
        self.cc2 = CC_module(filters[1])
